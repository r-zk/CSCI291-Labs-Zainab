  #include <stdio.h>		// give access to the stdio.h library //
    ...
    #define total_amount_cappucino "4.5 AED"    //cappaucino price defined//
    ...
    #define espresso_water_millilitres 30   //espresso water amount in milligrams defined//
    #define cappuccino_water_millilitres 30     //cappuccino water amount in milligrams defined//
    #define mocha_water_millilitres 39  //mocha water amount in milligrams defined//

    #define espresso_milk_millilitres 0 
